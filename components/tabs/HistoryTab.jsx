  ...
  if (!history.length) {
    return (
      ...
      >
        ...
        >
          No analyses yet. Analyse your first trailer!
        </p>
      </div>
    );
  }
      ...
      {history.map((h) => (
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            >
              {fmtDate(h.createdAt)} · Hype:{" "}
              {h.result?.hype_score ?? "?"}/100
            </div>
          </div>
          ...
          <button
            onClick={() => onLoad(h)}
            style={{
              background: "rgba(96,176,240,0.13)",
              border: "1px solid rgba(96,176,240,0.28)",
              borderRadius: 8,
              padding: "6px 12px",
              color: "#60b0f0",
              fontSize: 12,
